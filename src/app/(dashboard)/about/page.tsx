import { Info, ShieldCheck, Users, Zap } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500 py-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Empowering organizations to build, manage, and scale their workforce
          through intelligent and seamless human resource management.
        </p>
      </div>
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-card p-8 rounded-3xl border border-border/50 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-muted-foreground leading-relaxed relative z-10">
            To simplify the complexities of human resource management by
            providing an all-in-one platform that connects employees,
            streamlines operations, and fosters a transparent workplace culture.
            We believe in putting people first and letting technology handle the
            rest.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary/10 to-transparent p-8 rounded-3xl border border-primary/20 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-muted-foreground leading-relaxed relative z-10">
            To become the global standard for enterprise HR solutions, creating
            work environments where data drives decisions and every employee
            feels valued, supported, and connected to the company's core goals.
          </p>
        </div>
      </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl border bg-card text-center space-y-3 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-sm text-muted-foreground">
              Everything we build is designed to make the lives of employees and
              managers better.
            </p>
          </div>
          <div className="p-6 rounded-2xl border bg-card text-center space-y-3 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-sm text-muted-foreground">
              Your data is yours. We implement enterprise-grade security to
          ...
          <div className="p-6 rounded-2xl border bg-card text-center space-y-3 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-sm text-muted-foreground">
              We constantly evolve our platform to meet the dynamic needs of
              modern workplaces.
            </p>
          </div>
        </div>
